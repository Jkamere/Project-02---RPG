    ...
    while True:
        ...
        if choice in [exit.lower() for exit in exits]:
            ...
            if current_room.name.lower() == "room 901" and entered_room_901 and entered_room_902 and entered_room_903:
                correct_item_names4 = ["statue of the letter e", "statue", "e"]
                ...
                correct_item_names = ["a book", "book",]
                ...
                correct_item_names2 = ["tongue", "a tongue", "a plastic tongue"]
